...
export const translations: Record<string, Record<Language, string>> = {
    ...
    // IntelligentSelection.tsx - PD-1 Authorization Flow
    'authRequestTitle': { zh: '授权请求', en: 'Authorization Request' },
    'authRequestDescLine1': { zh: '本次查询涉及「TRIAL-2026-001 试验主数据（TRIAL_MASTER）」中的 L3 级加密字段，包含适应症、入排标准、目标入组数等敏感信息。', en: 'This query involves L3-grade encrypted fields in "TRIAL-2026-001 Trial Master Data (TRIAL_MASTER)", including indications, inclusion/exclusion criteria, target enrollment, and other sensitive information.' },
    'authRequestDescLine2': { zh: '依据《数据分级分类方案》安全策略（FR-6），请确认是否授权本次访问。', en: 'Per the Data Classification & Grading Policy (FR-6), please confirm whether to authorize this access.' },
    'authGrantBtn': { zh: '✔ 授权访问', en: '✔ Grant Access' },
    'authGrantedBtn': { zh: '✔ 已授权', en: '✔ Authorized' },
    'authDenyBtn': { zh: '✕ 拒绝', en: '✕ Deny' },
    'authDeniedBtn': { zh: '✕ 已拒绝', en: '✕ Denied' },
    'thinkingStatus': { zh: '思考中...', en: 'Thinking...' },
    'securityPreCheckTitle': { zh: '安全前置校验', en: 'Security Pre-check' },
    'authResultTitle': { zh: '授权验证结果', en: 'Authorization Verification Result' },
    'trialOntologyCallTitle': { zh: '调用工具：Trial 本体调用', en: 'Tool Call: Trial Ontology Call' },
    'accessDeniedMessage': { zh: '访问已被拒绝，操作终止。如需继续，请重新发送请求并授权访问。', en: 'Access denied. Operation terminated. To continue, please resend the request and grant access.' },
    'resultOutputLabel': { zh: '结果输出', en: 'Result' },
    'casesUnit': { zh: '例', en: 'cases' },
    'patientsPerMonth': { zh: '人/月', en: 'pts/mo' },
    'matchOver85': { zh: '匹配度 > 85%', en: 'Match > 85%' },
    'riskUnderControl': { zh: '风险管控中', en: 'Risk under control' },
    'oncologyStdV2': { zh: '肿瘤标准 v2', en: 'Oncology Std v2' },
    'unassigned': { zh: '未分配', en: 'Unassigned' },
    'reliabilityLabel': { zh: '信誉等级', en: 'Reliability' },
    'iso9001Cert': { zh: 'ISO 9001 认证', en: 'ISO 9001 Certified' },
    'hgrFastTrack': { zh: 'HGR 快速审批中心', en: 'HGR Fast Track' },
    'cancelBtn': { zh: '取消', en: 'Cancel' },
    'othersTag': { zh: '其它', en: 'Others' },
    'queryExamplePd1': { zh: '找华东地区做过 PD-1 试验的三甲医院', en: 'Looking for Grade A tertiary hospitals in East China with PD-1 experience' },
    'queryExampleNsclc': { zh: '北京地区 NSCLC 入组速率 Top 5', en: 'Top 5 NSCLC enrollment rate in Beijing' },
